...
VulkanTextureNode::~VulkanTextureNode()
{
    delete texture();
...
void VulkanTextureNode::createNativeTexture()
{
...
void VulkanTextureNode::releaseNativeTexture()
{
    if (!m_output)
        return;
...
void VulkanTextureNode::initialize()
{
    m_initialized = true;
